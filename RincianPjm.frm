...
Adodc1.RecordSource = "select Judul, JumlahFlm as Jumlah from Film,detailpjm,Pinjam where DetailPjm.NomorFlm=Film.NomorFlm and left(detailPjm.NomorPjm,8)=Pinjam.NomorPjm and Pinjam.NomorPjm='" & List1 & "'"
Adodc1.Refresh
