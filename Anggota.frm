...
Sub Form_Activate()
    Call BukaDB
    RSAnggota.Open "anggota", Conn
    Combo1.Clear
    Do Until RSAnggota.EOF
        Combo1.AddItem RSAnggota!NomorAgt
        RSAnggota.MoveNext
    Loop
End Sub
...
Function CariCombo()
    Call BukaDB
    RSAnggota.Open "Select * From Anggota where NomorAgt='" & Combo1 & "'", Conn
End Function
...
If Keyascii = 13 Then
    If CmdEdit.Caption = "&Simpan" Then
        ...
        If Not RSAnggota.EOF Then
            ...
            TxtNama.SetFocus
        Else
            MsgBox "Nomor Rekening Anggota Tidak Ada"
            TxtNomor.SetFocus
            Exit Sub
        End If
    ...
    ElseIf CmdHapus.Caption = "&Hapus" Then
        ...
        If Not RSAnggota.EOF Then
            ...
            If Pesan = vbYes Then
                Dim hapus As String
                hapus = "Delete From Anggota where NomorAgt= '" & TxtNomor & "'"
                Conn.Execute hapus
                KondisiAwal
                Form_Activate
            Else
